...
//   return (
//     <div className="hidden md:flex w-[200px], bg-[#1a2332] min-h-screen flex-col py-8 mt-6 px-4 rounded-tr-2xl rounded-br-3xl rounded-l-2xl shadow-lg m-2">
...
export function Sidebar() {
  ...
  return (
    <div className="w-[200px] bg-[#1a2332] min-h-screen flex flex-col py-8 px-4 rounded-tr-2xl rounded-br-3xl rounded-l-2xl shadow-lg m-2">
